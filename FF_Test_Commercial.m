...
rw1 = FF_test.bp*FF_test.Hp;
rw2 = rw1 + 0.1*f;
FF_test.wallInsulation{1, 2} = [rw1, rw2];     % m
...
rw3 = rw2 + 0.2*f;
FF_test.wallInsulation{2, 2} = [rw2, rw3]; % m
...
FF_test.nrbarW{3} = 50;
rw4 = rw3 + 0.1*f;
FF_test.wallInsulation{3, 2} = [rw3, rw4];  % m
...
FF_test.nrbarW{4} = 10;
rw5 = rw4 + 0.00635*f;
FF_test.wallInsulation{4, 2} = [rw4, rw5]; % m
...
zb1 = 0;
zb2 = zb1 + 0.1*f;
FF_test.baseInsulation{1, 2} = [zb1, zb2];
...
zb3 = zb2 + 0.1905*f;
FF_test.baseInsulation{2, 2} = [zb2, zb3];
...
FF_test.baseInsulation{2, 7} = 10;            % W/m2K contact conductance
...
zr1 = 0;
zr2 = zr1 + 0.3048*f;
FF_test.roofInsulation{1, 2} = [zr1, zr2];     % (m) dimensions/thickness [y1, y2]
...
zr3 = zr2 + 0.00635*f;
FF_test.roofInsulation{2, 2} = [zr2, zr3];

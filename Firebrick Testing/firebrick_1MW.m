...
Ins.nzbarW = 1000;
Ins.wallInsulation{1, 1} = 'firebrick';
Ins.nrbarW{1} = 500;
Ins.wallInsulation{1, 2} = [2.1214*f, 2.35*f];    % m
Ins.wallInsulation{1, 3} = 0.23;            % W/mK
Ins.wallInsulation{1, 4} = 705;            % kg/m3
Ins.wallInsulation{1, 5} = 2500;            % J/kgK
